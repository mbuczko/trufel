...
The general idea behind a project is to create a clone of [flame](https://github.com/pawelmalak/flame) as minimal as possible but extend it with more sophisticated authentication.
