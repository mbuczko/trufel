...
<div class="dialog w-full flex min-w-[540px] min-h-[270px] max-w-screen-md max-h-[270px] shadow-md border-1">
    <div class="sidebar grid grid-cols-[64px_1fr] justify-items-start bg-slate-500 rounded-tl-lg rounded-bl-lg p-2">
        ...
        <div class="col-span-2 text-left">
            <Toggle id="searchable" label="Searchable" enabled={isSearchable} />
        </div>
        <div class="col-span-2 text-left">
            <Toggle id="disabled" label="Disabled" enabled={isDisabled} />
        </div>
    </div>
